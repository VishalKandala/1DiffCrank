...
Cn1[-1,-1]=1+cfl
Cn[-1,-1]=1-cfl
Cn1[0,1]=-cfl/2 # Neumann BC u0_x=Const.
Cn[0,1]=cfl/2   # Neumann BC u0_x=Const.
Cn1[-1,-2]=-cfl/2 # Neumann BC un_x=Const.
Cn[-1,-2]=cfl/2 # Neumann BC un_x=Const.
...
nplot=5 # Number of successive timesteps after which to plot results
